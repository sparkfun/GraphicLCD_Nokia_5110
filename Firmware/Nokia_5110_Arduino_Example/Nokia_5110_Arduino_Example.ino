...
static const byte ASCII[][5] PROGMEM = {
  ...
  ,{0x02, 0x04, 0x08, 0x10, 0x20} // 5c \ (keep this to escape the backslash)
...
static const char SFEFlame[] PROGMEM = {
...
static const char SFEFlameBubble [] PROGMEM = {
...
static const char awesome[] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void LCDBitmap(const char my_array[]){
  for (int index = 0 ; index < (LCD_X * LCD_Y / 8) ; index++) {
    char byte = pgm_read_byte(&my_array[index]);
    LCDWrite(LCD_DATA, byte);
  }
}
...
void LCDCharacter(char character) {
  ...
  for (int index = 0 ; index < 5 ; index++) {
    ...
    char c = pgm_read_byte(&ASCII[character - 0x20][index]);
    LCDWrite(LCD_DATA, c);
  }
  LCDWrite(LCD_DATA, 0x00); //Blank vertical line padding
}
